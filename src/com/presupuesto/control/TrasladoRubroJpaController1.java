 ...
 */
public class TrasladoRubroJpaController1 implements Serializable {

    public TrasladoRubroJpaController1(EntityManagerFactory emf) {
        this.emf = emf;
    }
    ...
    public void destroy(BigDecimal id) throws NonexistentEntityException {
        ...
        try {
            em = getEntityManager();
            em.getTransaction().begin();
            TrasladoRubro trasladoRubro;
            try {
                trasladoRubro = em.getReference(TrasladoRubro.class, id);
                trasladoRubro.getIdTrasladoRubro();
            } catch (EntityNotFoundException enfe) {
                throw new NonexistentEntityException("The trasladoRubro with id " + id + " no longer exists.", enfe);
            }
            Traslado traslado = trasladoRubro.getTraslado();
            if (traslado != null) {
